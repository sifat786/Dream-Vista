        ...
        <div>
            ...
            <section className="my-8">
                <div className="container mx-auto flex flex-col items-center pb-6  md:p-10 md:px-12">
                    <h2 className="text-zinc-900 text-2xl md:text-3xl lg:text-4xl text-center font-semibold leading-9">Customers Review</h2>
                </div>
                <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20  md:px-10 md:pb-10 lg:grid-cols-2">
                    ...
                    <div className="flex flex-col items-center max-w-xl mx-12 lg:mx-0">
                        <div className="relative text-center">
